...
def display_landmarks_numbered(points, points_2=[], image_size=size):
    ...
    indexes_to_extract = [463, 263, 133, 33, 1, 2, 98, 327, 13, 61, 14, 291, 152, 447, 366, 401, 227, 137, 177, 10]
    ...
    for i, point in enumerate(points_stretched_original):
        ...
        cv2.circle(image, point, 1, (210, 210, 210), -1)
...
# def pick_points(
#         points,
#         indexes_to_extract=[1, 61 ,291, 0, 17, 2, 463, 263, 133, 33,  98, 327,  152, 447, 366, 401, 227,
#                                           137, 177, 10]):
#     points = [points[idx] for idx in indexes_to_extract]
#
#     return points
        ...
        if cap.isOpened():
            ...
            if ret:
                ...
                if len(faces) > 0:
                    ...
                    mini_face = [faces[0][idx] for idx in indexes_to_extract]

                    set_landmarks(url, mini_face)
